...
func _ready():
	#Vanilla patterns for custom head
	...
	#Custom pattern for vanilla heads
	Lure.assign_pattern_texture(ID,"pattern_hyena",ID+".species_hyena","mod://Textures/hyena_cat.png")
	Lure.assign_pattern_texture(ID,"pattern_hyena",ID+".species_hyena","mod://Textures/hyena_dog.png")
	
	#Face positioning for custom head
	Lure.assign_face_animation(ID,ID+".species_hyena","mod://Species/Animation/hyena_face.tres")
	
	#Custom species sounds
	...
	#Alternative head cosmetics for custom head
